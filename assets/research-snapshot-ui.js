...
window.RMSResearchSnapshotUI=(()=>{
 ...
 function workspaceHTML(p){
   ...
   return parts.length?`<section class="snapshot-group" id="snapshot-workspaces"><div class="snapshot-section-head"><div><h3>6 · Connected workspace records</h3><p>Important work stored in Literature, Methods/Data, Analysis, Writing, and related local tools.</p></div></div>${parts.join("")}</section>`:"";
 }
