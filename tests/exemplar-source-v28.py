...
bank=json.loads((r/"assets/exemplar-projects-v2.8.json").read_text(encoding="utf-8"))
...
text=(r/"docs/MULTI_PATH_SOURCE_VERIFICATION_v2.8.md").read_text(encoding="utf-8")
for doi in [
