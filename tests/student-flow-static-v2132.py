...
assert "Recommended from your current question type" in pathui
...
for token in ["What is this asking me to do?","Help me get unstuck","Look up a research term","Research Chat"]:
...
print("PASS v2.13.2 student-shell, progressive-disclosure, route, help, lab, and storage static integration")
