...
`v2.13 Classroom Pilot Freeze Rebased for v2.13`

Do not edit `index.html`, `404.html`, `.nojekyll`, `assets/`, `prompts/`, or `examples/` during a pilot wave.

Run

`python pilot/v2.13/scripts/verify_pilot_freeze.py`
...
Complete `TEACHER_ROUNDTRIP_REHEARSAL_v2.13.md` before involving students.
...
Use `FIRST_CONTACT_NOVICE_PROTOCOL_v2.13.md`.
