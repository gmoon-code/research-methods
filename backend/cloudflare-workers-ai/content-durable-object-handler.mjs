...
class ContentReleaseCoordinatorHandler {
  constructor(
    storage
  ) {
    this.coordinator =
...
function createContentReleaseCoordinatorHandler(
  storage
) {
  return new ContentReleaseCoordinatorHandler(
    storage
  );
}

export {
  ContentReleaseCoordinatorHandler,
  INTERNAL_ORIGIN,
